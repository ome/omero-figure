...
urlpatterns = [
    ...
    path(r"file/<int:file_id>/",
         views.index,
         name="load_figure"),
    path(r"imgData/<int:image_id>/",
         views.img_data_json,
         name="figure_imgData"),
    # Send json to OMERO to create pdf using scripting service
    path(r"make_web_figure/",
         views.make_web_figure,
         name="make_web_figure"),
    # Save json to file annotation
    path(r"save_web_figure/",
         views.save_web_figure,
         name="save_web_figure"),
    # Get json from file (file annotation Id)
    path(
        r"load_web_figure/<int:file_id>/",
        views.load_web_figure,
        name="load_web_figure"
    ),
    # List file annotations of saved Figures
    path(r"list_web_figures/",
         views.list_web_figures,
    ...
    # annotation
    path(r"delete_web_figure/",
         views.delete_web_figure,
    ...
    path(r"timestamps/",
         views.timestamps,
         name="figure_timestamps"),
    path(r"roiCount/<int:image_id>/",
         views.roi_count,
