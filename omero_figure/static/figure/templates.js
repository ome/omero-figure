...
((__t = ( y )) == null ? '' : __t) +
'">\n                        </div>\n                        <label class="col-sm-2 control-label" style="position:relative">\n                            <button type="button" class="btn btn-link set_aspect_ratio" \n                                style="position:absolute; left:28px; top:-19px; padding:3px; color: rgb(256,0,0)"\n                                title="Maintain aspect ratio">\n                                <span class="glyphicon glyphicon-link"></span>\n                            </button> \n                            <div class="col-sm-6" style="position:absolute; left:38px; top:-22.5px;">\n                                <input name="dummy" class="form-control input-sm" style="border-right:0; background-color:white" readonly>\n                            </div>\n                            Height\n                        </label>\n                        <div class="col-sm-4">\n                            <input type="number" name="height" min="0" class="form-control input-sm" value="' +
((__t = ( height )) == null ? '' : __t) +
'">\n                        </div>\n                    </div>\n                </form>\n            </td></tr>\n        </tbody>\n    </table>\n';
