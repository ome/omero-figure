                ...
                if (matches.length>0){ 
                    ...
                    for (const match of matches) {// Loops on the match to replace in the ljson.text the expression by their values
                        ...
                        if (['time', 't'].includes(prop_nf[0])) {
                            ...
                            precision = param_dict["precision"] ? param_dict["precision"] : 0; // decimal places default to 0
                            ...
                            precision = param_dict["precision"] ? param_dict["precision"] : 2; // decimal places default to 2
