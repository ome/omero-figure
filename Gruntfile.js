    ...
    concat: {
      options: {
                banner: "//! AGPL License. www.openmicroscopy.org\n\n" +
                    "//!  DO NOT EDIT THIS FILE! - Edit under src/js/\n" +
                    "//!  This file was created by $ grunt concat\n\n",
      },
      model: {
        src: [
          "<banner>",
          'src/js/models/*.js'],
        dest: 'omero_figure/static/figure/figure_models.js',
      },
      views: {
        src: [
          "<banner>",
          'src/js/views/*.js',
          'src/js/app.js'],
        dest: 'omero_figure/static/figure/figure_views.js',
      },
    },
    replace: {
      dist: {
